...
st.set_page_config(page_title="Amex Dashboard", layout="wide")
        ...
        if uploaded_file:
            ...
            if st.session_state.synthetic_data is not None:
                ...
                for column in columns:
                    st.markdown("<h4 style='text-align: center; color: black;'> {column} </h4>", unsafe_allow_html=True)
                    ...
                    with reference_col:
                        ...
                        st.markdown("<h5 style='text-align: What {column} data says; color: black;'> {column} </h5>", unsafe_allow_html=True)
                        st.write(insights)
                        st.markdown('#')
                        st.markdown("---")  
